...
tags$style(type="text/css", # isso é para não mostrar nenhuma mensagem vermelha de erro!!
  ...
  navbarPage("MEG", # Navegação
            ...
            sidebarPanel(width = 3, # Numero de colunas
						  ...
						  br(),
						  p("Os indicadores estão agrupados por quatro dimensões: ", strong("Nível de Atividade, Mercado de Trabalho, Indicadores de Confiança, Inadimplência e Crédito e Índices de Preços"), "."), 
						  br(),
                          
						   
			selectInput('series_compara_hierarquia', 'Escolha o indicador:', choices = list(
			...
			sidebarPanel(width = 3,
						  ...
						  br(),
						div(bsButton("info_tabela", label = "Informações", icon = icon("info"), style = "info", size = "medium"), align = "center"),
						bsPopover(id = "info_tabela", title = "Informações da Tabela",
						  ...
						  h4("Filtrar Tabela"),
						  checkboxInput('check_grupo_tabela', "Visualizar somente um grupo de indicadores?", value=F),
            ...
            mainPanel(width = 9, # Complementar do width do sidebar
						...
						br(),
						column(12, formattableOutput("tabela_colla_final")),
               ...
               tabPanel("Dinâmica Macroeconômica",
						...
						div(bsButton("info_monitor", label = "Informações", icon = icon("info"), style = "info", size = "medium"), align = "center"),
						bsPopover(id = "info_monitor", title = "Informações do Monitor",
						...
						h4("Aceleração: representa a variação mensal do crescimento.")
